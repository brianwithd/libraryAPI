...
4. [Author Endpoints](#author-endpoints)
   - [Author Register Account](#author-register-account)
   - [Author Login Account](#author-login-account)
   - [Author Authenticate Account](#author-authenticate-account)
...
6. [Admin Endpoints](#admin-endpoints)
   ...
   - [Admin Authenticate Account](#admin-authenticate-account)
...
7. [User Endpoints](#user-endpoints)
   - [User Register Account](#user-register-account)
   - [User Login Account](#user-login-account)
   - [User Authenticate Account](#user-authenticate-account)
